...
{
public:
	Attack(int damage, double bullet_speed, int interval, Character* chara); //コンストラクタ
	Attack(int damage, double bullet_speed, int interval, Character* charam, char* sound_name); //コンストラクタ
	...
	int GetBulletsSize();
	//int damage(){return bullet_damage_;}
